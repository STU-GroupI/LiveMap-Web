...
namespace LiveMapDashboard.Web.Models.Providers
{
    public class RequestForChangeListViewModelProvider : IViewModelProvider<RequestForChangeListViewModel>
    {
        ...
        {
            PaginatedResult<RequestForChange> result = (await _rfcService.GetMultiple(viewModel.MapId, viewModel.Skip, viewModel.Take, viewModel.Ascending, true)).Value ?? PaginatedResult<RequestForChange>.Default;
